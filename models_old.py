...
class input_odp(db.Model):
    ...
    IdDocumento = db.Column(db.String, nullable=False)
    IdRiga = db.Column(db.String, nullable=False)
    RifRegistraz = db.Column(db.String, nullable=False)
    CodArt = db.Column(db.String, nullable=False)
    Quantita = db.Column(db.String, nullable=False)
    NumFase = db.Column(db.String, nullable=False)
    CodLavorazione = db.Column(db.String, nullable=False)
    CodRisorsaProd = db.Column(db.String, nullable=False)
    DataInizioSched = db.Column(db.String, nullable=False)
    DataFineSched = db.Column(db.String, nullable=False)
    GestioneLotto = db.Column(db.String, nullable=False)
    GestioneMatricola = db.Column(db.String, nullable=False)
    DistintaMateriale = db.Column(db.String, nullable=False)
    CodMatricola = db.Column(db.String, nullable=False)
    StatoRiga = db.Column(db.String, nullable=False)
    CodFamiglia = db.Column(db.String, nullable=False)
    CodMacrofamiglia = db.Column(db.String, nullable=False)
    CodMagPrincipale = db.Column(db.String, nullable=False)
    CodReparto = db.Column(db.String, nullable=False)
    TempoPrevistoLavoraz = db.Column(db.String, nullable=False)

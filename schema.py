...
def _render_column(table: Table, col) -> str:
    ...
    if col.server_default is not None:
        kwargs.append(f"server_default=db.text({str(col.server_default.arg)!r})")
...
def generate_models(db_url: str, out_path: Path) -> None:
    ...
    tables: Iterable[Table] = (
        metadata.tables[name] for name in sorted(metadata.tables.keys())
    )
...
if __name__ == "__main__":
    ...
    generate_models(
        db_url="sqlite:///app_odp/instance/policy.db",

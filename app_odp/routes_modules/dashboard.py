...
def api_dashboard_produzione_kpi_export():
    ...
    detail_headers = [
        ...
        ("quantita_conforme", "Quantità conforme"),
        ("quantita_non_conforme", "Quantità non conforme"),
        ("quantita_consuntivata", "Quantità consuntivata"),
        ("lead_time_ore", "Lead time ore"),
        ("dati_completi", "Dati completi"),
